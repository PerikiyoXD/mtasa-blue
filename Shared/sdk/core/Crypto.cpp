...
namespace SharedUtil
{
    ...
    SString Base32encode(const SString& data, const SString& variant)
    {
        SString result;
    ...
    SString Base32decode(const SString& data, const SString& variant)
    {
        SString result;
    ...
    int ZLibCompress(const std::string& input, std::string& output, const int windowBits, const int compression,
                            const ZLibStrategy strategy)
    {
        z_stream stream{};
    ...
    int ZLibUncompress(const std::string& input, std::string& output, int windowBits)
    {
