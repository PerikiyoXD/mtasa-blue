...
public:
    float  pad1;            // 56
    std::uint32_t pad2;            // 60

    std::uint32_t b0x01 : 1;            // 64
    std::uint32_t bApplyGravity : 1;
    std::uint32_t bDisableFriction : 1;
    std::uint32_t bCollidable : 1;
    std::uint32_t b0x10 : 1;
    std::uint32_t bDisableMovement : 1;
    std::uint32_t b0x40 : 1;
    std::uint32_t b0x80 : 1;

    std::uint32_t bSubmergedInWater : 1;            // 65
    std::uint32_t bOnSolidSurface : 1;
    std::uint32_t bBroken : 1;
    std::uint32_t b0x800 : 1;                     // ref @ 0x6F5CF0
    std::uint32_t b0x1000 : 1;                    //
    std::uint32_t bDontApplySpeed : 1;            //
    std::uint32_t b0x4000 : 1;                    //
    std::uint32_t b0x8000 : 1;                    //

    std::uint32_t b0x10000 : 1;            // 66
    std::uint32_t b0x20000 : 1;            // ref @ CPhysical__processCollision
    std::uint32_t bBulletProof : 1;
    std::uint32_t bFireProof : 1;
    std::uint32_t bCollisionProof : 1;
    std::uint32_t bMeeleProof : 1;
    std::uint32_t bInvulnerable : 1;
    std::uint32_t bExplosionProof : 1;

    std::uint32_t b0x1000000 : 1;            // 67
    std::uint32_t bAttachedToEntity : 1;
    std::uint32_t b0x4000000 : 1;
    std::uint32_t bTouchingWater : 1;
    std::uint32_t bEnableCollision : 1;
    std::uint32_t bDestroyed : 1;
    ...
    std::uint32_t*                   m_pCollisionList;                           // 176
    std::uint32_t*                   m_pMovingList;                              // 180
    std::uint8_t                     m_ucColFlag1;                               // 184
    std::uint8_t                     m_ucCollisionState;                         // 185
    std::uint8_t                     m_ucCollisionContactSurfaceType;            // 186
    std::uint8_t                     m_ucColFlag4;                               // 187
    ...
    std::uint16_t                    m_usPieceType;                              // 248
    std::uint16_t                    m_pad3;                                     // 250
